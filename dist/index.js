...
var require_css_escape = __commonJS({
  "node_modules/css.escape/css.escape.js"(exports2, module2) {
    ...
    })(typeof global != "undefined" ? global : exports2, function(root) {
...
function runNpmAudit(fix = false) {
  ...
  return new Promise(
    (resolve, reject) => (0, import_node_child_process.exec)(`npm audit --json ${fix ? "fix" : ""}`, (error2, stdout, stderr) => {
      if (error2) {
        debug(`[npm audit] Error: ${error2.message}`);
      }
      if (stderr) {
        debug(`[npm audit]: ${stderr}`);
      }
      if (stdout) {
...
async function formatNpmAuditOutput(data) {
  ...
  if (forceFixable.length) {
    info(`And ${forceFixable.length} only fixable manually using --force`);
  }
